...
# Multiply the count by value to get the score
df2['Score'] = df2['Count']*df2['Values']
#Normalize the count value and score value to total counts
df2['Normalized Count']=df2['Count']/df['Count'].sum()
df2['Normalized Score']=abs(df2['Normalized Count']*df2['Values'])
df2

#Average sentiment value
df2['Score'].sum()/df2['Count'].sum()
